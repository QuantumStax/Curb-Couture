  ...
  return (
    <div className="relative top-[-4rem] w-full h-[100vh] overflow-hidden bg-secondary_2">
      ...
      >
        <a
          href="#"
          className="rotate-90 w-fit nav-hover-social focus:outline-none focus:ring-2 focus:ring-primary_2"
          tabIndex={0}
        >
          Instagram
        </a>
      ...
      <div className="absolute left-[4%] top-[15vh] z-20 text-primary_2 w-[45%]">
        <h1 className="uppercase text-8xl tracking-tight font-Roman-SD special-font">
          Wearable Art Redefined
        </h1>
        <p className="mt-4 text-xl font-light">
          Discover bold designs that speak your style.
        </p>
        <button className="mt-8 flex items-center gap-2 rounded-full bg-primary_2 text-secondary_light px-6 py-3 hover:bg-banner_2 hover:text-primary_2 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary_2">
      ...
      <div className='relative right-10 text-primary_2'>
        ...
        <img
          ...
          className="w-[50%] object-cover rounded-lg transform transition duration-300 hover:scale-105 hover:shadow-xl"
          loading="lazy"
        />
        <img
          src="/images/hero/obito_anime_oversized_tshirt.webp"
          alt="Limited Edition Oversized T-Shirt with dynamic design"
          className="w-[50%] h-[30rem] object-cover rounded-lg transform transition duration-300 hover:scale-105 hover:shadow-xl"
          loading="lazy"
        />
      </div>
